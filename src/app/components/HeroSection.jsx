  ...
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-orange-300 mb-4 text-4xl sm:text-5xl 
          lg:text-8xl lg:leading-normal font-serif  ">
          ...
          <div>
            ...
            >
              <span className="block bg-[#6d828a] hover:bg-slate-800 rounded-full px-5 py-2">
                Download CV
              </span>
            </Link>
          </div>
